    ...
    <div class="container">
            ...
            <div class="col-xs-12 col-md-6">
                <div class="col-xs-12 no-padding">
                    <h3 class="text-headline">
                        <p class="fw-bold text-dark">Contenido</p>
                    </h3>
        ...
        <div class="col">
            <p class="text-subhead align-text-justify fw-bold text-dark">
                ...
                Noé Zúñiga Morales & Diana Godinez Roblero, All Rights Reserved. <br></br>
                Fecha de creación: 27/04/2022
                Ultima Actualización: 06/06/2022
            </p>
        </div>
    </div>
    <!-- BackToTop Button -->
    <a class="aumentar" href="javascript:void(0);" id="scroll" title="Scroll to Top" style="display: none;"><span></span></a>
</footer>

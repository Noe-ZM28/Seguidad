...
<div class="d-flex align-items-start min-vh-100">
    <div class="nav flex-column nav-pills me-3 bg-secondary min-vh-100" id="v-pills-tab" role="tablist" aria-orientation="vertical">
        <button class="nav-link active fw-bold text-dark " id="actividad_1-tab" data-bs-toggle="pill" data-bs-target="#actividad_1" type="button" role="tab" aria-controls="actividad_1" aria-selected="true">
            Actividad 1
        </button>

        <button class="nav-link fw-bold text-dark " id="actividad_2-tab" data-bs-toggle="pill" data-bs-target="#actividad_2" type="button" role="tab" aria-controls="actividad_2" aria-selected="false">
            Actividad 2
        </button>

        <button class="nav-link fw-bold text-dark" id="actividad_3-tab" data-bs-toggle="pill" data-bs-target="#actividad_3" type="button" role="tab" aria-controls="actividad_3" aria-selected="false">
            Actividad 3
        </button>
    ...
    <div class="tab-content" id="v-pills-tabContent">
        ...
        <div class="tab-pane fade" id="actividad_3" role="tabpanel" aria-labelledby="actividad_3-tab">
            <center>
        ...
        <div class="tab-pane fade" id="actividad_4" role="tabpanel" aria-labelledby="actividad_4-tab">
            <center>
